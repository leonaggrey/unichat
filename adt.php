...
<body>
    <main>
        ...
        <section id="chats">
            ...
            <div id="messages">
				...
				<?php
					...
					if(isset($_POST['submit'])) {
						include("adt_chats.php");
					}else{
						include("adt_retrieve.php");
					}?>
			...
			<div id="popup">
				<div>
				<h1>Class Concerns/Queries</h1>
				
				</div>
				
				<form id="poptext" name="concernform" method="post" action="adt.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
			...
			<div >
            <form method="post" id="text" action="adt.php" enctype="multipart/form-data">

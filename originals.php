...
<head>
	...
	<link rel="stylesheet" href="chats1.css">
    ...
    <main>
        ...
        <section id="chats">
			...
			<div id="popup">
				...
				<form id="poptext" name="concernform" method="post" action="chats.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
				...
				<div ><a href="chat.php" class="chat_link">
					<div class="chat_icon">

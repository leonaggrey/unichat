...
<body>
    <main>
        ...
        <section id="chats">
			...
			<div id="popup">
				<div>
				<h1>University Concerns/Queries</h1>
				
				</div>
				<?php
				
					if(isset($_POST['submitp'])) {
						include("university_concern_send.php");
					}?>
				
				<form id="poptext" name="concernform" method="post" action="home.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
					...
					<input type="text" name="username" value="<?php echo $username="Leon A"?>" style="display:none">
					<div id="buttons">
					<button id="close-button">Close</button>
					<button type="submit" name="submitp" id="popsubmit">Send</button>
					</div>
				</form>
			</div> 
			</div>
			...
			<div id="suggestion_mess">
				<div id="messleft">
					<div id="suggbox">
						<p>Do you have anything of concern to improve on or complain about?</p>	<br>
						<p>Kindly tell us below;</p>
			...
			<div>
            <form method="post" id="text" action="suggestion.php" enctype="multipart/form-data">

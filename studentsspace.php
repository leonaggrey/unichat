    ...
    <main>
        ...
        <section id="chats">
            <div id="respondent">
				...
				<h1><a href="classmembers.php" style="text-decoration:none;">Students Room</a></h1>
            ...
            <div id="messages">
				...
				<?php
					...
					if(isset($_POST['submit'])) {
						include("students_send.php");
					}else{
						include("students_retrieve.php");
					}
					?>
			...
			<div id="popup">
				...
				<form id="poptext" name="concernform" method="post" action="studentsspace.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
			...
			<div >
            <form method="post" id="text" action="studentsspace.php" enctype="multipart/form-data">
